...
public class App_chatroom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_chatroom);

        rv_chatlist = (RecyclerView) findViewById(R.id.rv_chatroom);
        chatlist =new ArrayList<>();
        rv_adapter =new ChatlistAdapter(chatlist);
        LinearLayoutManager verticalLayoutmanager
                = new LinearLayoutManager(App_chatroom.this, LinearLayoutManager.VERTICAL, false);
    ...
    public class ChatlistAdapter extends RecyclerView.Adapter<ChatlistAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.rv_chatlist, parent, false);
